...
###########################################
base_dir <- "Deseq2/PRJNA552352 - Leishmania/"
...
phenoData <- read_excel("./Deseq2/PRJNA552352 - Leishmania/PRJNA552352.xlsx", col_names = TRUE)
lista <- phenoData$id
...
run_venn_analysis(dds_BALB_c, dds_C57BL_6,
                  "Control_Non-infected_vs_LPS", "Control_Non-infected_vs_Linf_Infected",
