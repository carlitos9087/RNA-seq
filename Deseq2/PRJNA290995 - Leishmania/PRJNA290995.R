...
###########################################
base_dir <- "Deseq2/PRJNA290995 - Leishmania/"
...
phenoData <- read_excel("./Deseq2/PRJNA290995 - Leishmania/PRJNA290995.xlsx", col_names = TRUE)
lista <- phenoData$id
...
# dds_BALB_c <- run_deseq_analysis(data, phenoData, "Control_Non-infected", "LPS",
#                                  file.path(results_dir, "DESeq2_Control_Non-infected_vs_LPS.tabular"))
# 
# 
# dds_C57BL_6 <- run_deseq_analysis(data, phenoData, "Control_Non-infected", "Linf_Infected",
#                                   file.path(results_dir, "DESeq2_Control_Non-infected_vs_Linf_Infected.tabular"))
# 
# 
# 
# 
# 
# pca_24h <- run_pca_analysis(dds_BALB_c, file.path(results_dir, "PCA_Control_Non-infected_vs_LPS.jpeg"))
# pca_8h <- run_pca_analysis(dds_C57BL_6, file.path(results_dir, "PCA_Control_Non-infected_vs_Linf_Infected.jpeg"))
# 
# 
# 
# run_sample_distances(dds_BALB_c, file.path(results_dir, "SampleDistances_Control_Non-infected_vs_LPS.jpeg"))
# run_sample_distances(dds_C57BL_6, file.path(results_dir, "SampleDistances_Control_Non-infected_vs_Linf_Infected.jpeg"))
# 
# 
# run_dispersion_plot(dds_BALB_c, file.path(results_dir, "Dispersion_Control_Non-infected_vs_LPS.jpeg"))
# run_dispersion_plot(dds_C57BL_6, file.path(results_dir, "Dispersion_Control_Non-infected_vs_Linf_Infected.jpeg"))
# 
# 
# run_pval_histogram(dds_BALB_c, file.path(results_dir, "Histogram_pvalues_Control_Non-infected_vs_LPS.jpeg"))
# run_pval_histogram(dds_C57BL_6, file.path(results_dir, "Histogram_pvalues_Control_Non-infected_vs_Linf_Infected.jpeg"))
# 
# ma1 = run_ma_plot(dds_BALB_c, file.path(results_dir, "MAplot_Control_Non-infected_vs_LPS.jpeg"))
# ma2 = run_ma_plot(dds_C57BL_6, file.path(results_dir, "MAplot_Control_Non-infected_vs_Linf_Infected.jpeg"))
# 
# head(ma1$data)
# 
# # Executa e salva os Volcano Plots
# run_volcano_plot(dds_BALB_c, file.path(results_dir, "Volcano_Control_Non-infected_vs_LPS.jpeg"))
# run_volcano_plot(dds_C57BL_6, file.path(results_dir, "Volcano_Control_Non-infected_vs_Linf_Infected.jpeg"))

# Define a lista de comparações: cada elemento contém um vetor com:
# [1] grupo controle (Uninfected) e [2] grupo tratado (Infected)
...
up_down_enrich_results <- run_deseq_up_down_enrichment(dds = dds_list$Lmj_48h,
                                                       up_threshold = 1,
                                                       down_threshold = -1,
                                                       padj_cutoff = 0.05,
                                                       ont = "BP",
                                                       ...
                                                       pvalueCutoff = 0.05,
                                                       qvalueCutoff = 0.2,
                                                       output_file_prefix = file.path(results_dir, "DESeq2_UpDown__dds_Lmj_48h"))

up_down_enrich_results <- run_deseq_up_down_enrichment(dds = dds_list$Lmj_24h,
                                                       up_threshold = 1,
                                                       down_threshold = -1,
                                                       padj_cutoff = 0.05,
                                                       ont = "BP",
                                                       ...
                                                       pvalueCutoff = 0.05,
                                                       qvalueCutoff = 0.2,
                                                       output_file_prefix = file.path(results_dir, "DESeq2_UpDown__dds_Lmj_24h"))

up_down_enrich_results <- run_deseq_up_down_enrichment(dds = dds_list$Lmj_4h,
                                                       up_threshold = 1,
                                                       down_threshold = -1,
                                                       padj_cutoff = 0.05,
                                                       ont = "BP",
                                                       ...
                                                       pvalueCutoff = 0.05,
                                                       qvalueCutoff = 0.2,
                                                       output_file_prefix = file.path(results_dir, "DESeq2_UpDown__dds_Lmj_4h"))

up_down_enrich_results <- run_deseq_up_down_enrichment(dds = dds_list$Lama_72h,
                                                       up_threshold = 1,
                                                       down_threshold = -1,
                                                       padj_cutoff = 0.05,
                                                       ont = "BP",
                                                       ...
                                                       pvalueCutoff = 0.05,
                                                       qvalueCutoff = 0.2,
                                                       output_file_prefix = file.path(results_dir, "DESeq2_UpDown__dds_Lama_72h"))

up_down_enrich_results <- run_deseq_up_down_enrichment(dds = dds_list$Lama_48h,
                                                       up_threshold = 1,
                                                       down_threshold = -1,
                                                       padj_cutoff = 0.05,
                                                       ont = "BP",
                                                       ...
                                                       pvalueCutoff = 0.05,
                                                       qvalueCutoff = 0.2,
                                                       output_file_prefix = file.path(results_dir, "DESeq2_UpDown__dds_Lama_48h"))

up_down_enrich_results <- run_deseq_up_down_enrichment(dds = dds_list$Lama_24h,
                                                       up_threshold = 1,
                                                       down_threshold = -1,
                                                       padj_cutoff = 0.05,
                                                       ont = "BP",
                                                       ...
                                                       pvalueCutoff = 0.05,
                                                       qvalueCutoff = 0.2,
                                                       output_file_prefix = file.path(results_dir, "DESeq2_UpDown__dds_Lama_24h"))

up_down_enrich_results <- run_deseq_up_down_enrichment(dds = dds_list$Lama_4h,
                                                       up_threshold = 1,
                                                       down_threshold = -1,
                                                       padj_cutoff = 0.05,
                                                       ont = "BP",
                                                       ...
                                                       pvalueCutoff = 0.05,
                                                       qvalueCutoff = 0.2,
                                                       output_file_prefix = file.path(results_dir, "DESeq2_UpDown__dds_Lama_4h"))
