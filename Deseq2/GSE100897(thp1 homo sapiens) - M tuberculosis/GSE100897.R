...
###########################################
base_dir <- "Deseq2/GSE100897(thp1 homo sapiens) - M tuberculosis/"
...
phenoData <- read_excel("Deseq2/GSE100897(thp1 homo sapiens) - M tuberculosis/GSE100897.xlsx", col_names = TRUE)
lista <- phenoData$id
...
dds_Control_24h_vs_Infected_24h <- run_deseq_analysis(
  data, phenoData, 
  "THP-1_uninfected_Control_24h",    # Grupo controle (24h não infectado)
  "THP-1_infected_24h",              # Grupo experimental (24h infectado)
  file.path(results_dir, "DESeq2_Control_24h_vs_Infected_24h.tabular")
)

dds_Control_6h_vs_Infected_6h <- run_deseq_analysis(
  data, phenoData, 
  "THP-1_uninfected_Control_6h",     # Grupo controle (6h não infectado)
  "THP-1_infected_6h",               # Grupo experimental (6h infectado)
  file.path(results_dir, "DESeq2_Control_6h_vs_Infected_6h.tabular")
)

# Análises de PCA
pca_Control_24h_vs_Infected_24h <- run_pca_analysis(
  dds_Control_24h_vs_Infected_24h, 
  file.path(results_dir, "PCA_Control_24h_vs_Infected_24h.jpeg")
)

pca_Control_6h_vs_Infected_6h <- run_pca_analysis(
  dds_Control_6h_vs_Infected_6h, 
  file.path(results_dir, "PCA_Control_6h_vs_Infected_6h.jpeg")
)

# Distâncias entre amostras
run_sample_distances(
  dds_Control_24h_vs_Infected_24h, 
  file.path(results_dir, "SampleDistances_Control_24h_vs_Infected_24h.jpeg")
)

run_sample_distances(
  dds_Control_6h_vs_Infected_6h, 
  file.path(results_dir, "SampleDistances_Control_6h_vs_Infected_6h.jpeg")
)

# Gráficos de dispersão
run_dispersion_plot(
  dds_Control_24h_vs_Infected_24h, 
  file.path(results_dir, "Dispersion_Control_24h_vs_Infected_24h.jpeg")
)

run_dispersion_plot(
  dds_Control_6h_vs_Infected_6h, 
  file.path(results_dir, "Dispersion_Control_6h_vs_Infected_6h.jpeg")
)

# Histogramas de p-values
run_pval_histogram(
  dds_Control_24h_vs_Infected_24h, 
  file.path(results_dir, "Histogram_pvalues_Control_24h_vs_Infected_24h.jpeg")
)

run_pval_histogram(
  dds_Control_6h_vs_Infected_6h, 
  file.path(results_dir, "Histogram_pvalues_Control_6h_vs_Infected_6h.jpeg")
)

# MA Plots
ma_Control_24h_vs_Infected_24h <- run_ma_plot(
  dds_Control_24h_vs_Infected_24h, 
  file.path(results_dir, "MAplot_Control_24h_vs_Infected_24h.jpeg")
)

ma_Control_6h_vs_Infected_6h <- run_ma_plot(
  dds_Control_6h_vs_Infected_6h, 
  file.path(results_dir, "MAplot_Control_6h_vs_Infected_6h.jpeg")
)

# Volcano Plots
run_volcano_plot(
  dds_Control_24h_vs_Infected_24h, 
  file.path(results_dir, "Volcano_Control_24h_vs_Infected_24h.jpeg")
)

run_volcano_plot(
  dds_Control_6h_vs_Infected_6h, 
  file.path(results_dir, "Volcano_Control_6h_vs_Infected_6h.jpeg")
)
...
run_venn_analysis(
  dds_Control_24h_vs_Infected_24h, 
  dds_Control_6h_vs_Infected_6h,
  "Control_24h_vs_Infected_24h", 
  "Control_6h_vs_Infected_6h",
  file.path(results_dir, "Venn_24h_vs_6h_Infected")
)
...
up_down_enrich_24h <- run_deseq_up_down_enrichment(
  dds = dds_Control_24h_vs_Infected_24h,
  up_threshold = 1,
  down_threshold = -1,
  padj_cutoff = 0.05,
  ont = "BP",
  ...
  pvalueCutoff = 0.05,
  qvalueCutoff = 0.2,
  output_file_prefix = file.path(results_dir, "DESeq2_UpDown_Control_24h_vs_Infected_24h")
)

up_down_enrich_6h <- run_deseq_up_down_enrichment(
  dds = dds_Control_6h_vs_Infected_6h,
  up_threshold = 1,
  down_threshold = -1,
  padj_cutoff = 0.05,
  ont = "BP",
  ...
  pvalueCutoff = 0.05,
  qvalueCutoff = 0.2,
  output_file_prefix = file.path(results_dir, "DESeq2_UpDown_Control_6h_vs_Infected_6h")
)
