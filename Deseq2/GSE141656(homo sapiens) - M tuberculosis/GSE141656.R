...
###########################################
base_dir <- "Deseq2/GSE141656(homo sapiens) - M tuberculosis/"
...
phenoData <- read_excel("./Deseq2/GSE141656(homo sapiens) - M tuberculosis/GSE141656.xlsx", col_names = TRUE)
lista <- phenoData$id
...
# 1. BG_RPMI vs. RPMI_RPMI (Treinamento com beta-glucano)
dds_TrainingEffect <- run_deseq_analysis(
  data, phenoData, 
  "6_day_media_(control)",         # Grupo controle (não treinado)
  "BG_24hr_5_day_media",           # Grupo experimental (treinado com beta-glucano)
  file.path(results_dir, "DESeq2_6_day_media_(control)_vs_BG_24hr_5_day_media.tabular")
)

# 2. BG_MTB vs. BG_RPMI (Resposta ao Mtb em macrófagos treinados)
dds_TrainedResponseToMtb <- run_deseq_analysis(
  data, phenoData, 
  "BG_24hr_5_day_media",           # Grupo controle (treinado, sem Mtb)
  "BG_24hr_5_day_media_MTB_4hr",   # Grupo experimental (treinado, com Mtb)
  file.path(results_dir, "DESeq2_BG_24hr_5_day_media_vs_BG_24hr_5_day_media_MTB_4hr.tabular")
)

# 3. RPMI_MTB vs. RPMI_RPMI (Resposta ao Mtb em macrófagos não treinados)
dds_NonTrainedResponseToMtb <- run_deseq_analysis(
  data, phenoData, 
  "6_day_media_(control)",         # Grupo controle (não treinado, sem Mtb)
  "6_day_media_MTB_4hr",           # Grupo experimental (não treinado, com Mtb)
  file.path(results_dir, "DESeq2_6_day_media_(control)_vs_6_day_media_MTB_4hr.tabular")
)

# Análises de PCA
pca_TrainingEffect <- run_pca_analysis(
  dds_TrainingEffect, 
  file.path(results_dir, "PCA_6_day_media_(control)_vs_BG_24hr_5_day_media.jpeg")
)

pca_TrainedResponseToMtb <- run_pca_analysis(
  dds_TrainedResponseToMtb, 
  file.path(results_dir, "PCA_BG_24hr_5_day_media_vs_BG_24hr_5_day_media_MTB_4hr.jpeg")
)

pca_NonTrainedResponseToMtb <- run_pca_analysis(
  dds_NonTrainedResponseToMtb, 
  file.path(results_dir, "PCA_6_day_media_(control)_vs_6_day_media_MTB_4hr.jpeg")
)

# Distâncias entre amostras
run_sample_distances(
  dds_TrainingEffect, 
  file.path(results_dir, "SampleDistances_6_day_media_(control)_vs_BG_24hr_5_day_media.jpeg")
)

run_sample_distances(
  dds_TrainedResponseToMtb, 
  file.path(results_dir, "SampleDistances_BG_24hr_5_day_media_vs_BG_24hr_5_day_media_MTB_4hr.jpeg")
)

run_sample_distances(
  dds_NonTrainedResponseToMtb, 
  file.path(results_dir, "SampleDistances_6_day_media_(control)_vs_6_day_media_MTB_4hr.jpeg")
)

# Gráficos de dispersão
run_dispersion_plot(
  dds_TrainingEffect, 
  file.path(results_dir, "Dispersion_6_day_media_(control)_vs_BG_24hr_5_day_media.jpeg")
)

run_dispersion_plot(
  dds_TrainedResponseToMtb, 
  file.path(results_dir, "Dispersion_BG_24hr_5_day_media_vs_BG_24hr_5_day_media_MTB_4hr.jpeg")
)

run_dispersion_plot(
  dds_NonTrainedResponseToMtb, 
  file.path(results_dir, "Dispersion_6_day_media_(control)_vs_6_day_media_MTB_4hr.jpeg")
)

# Histogramas de p-values
run_pval_histogram(
  dds_TrainingEffect, 
  file.path(results_dir, "Histogram_pvalues_6_day_media_(control)_vs_BG_24hr_5_day_media.jpeg")
)

run_pval_histogram(
  dds_TrainedResponseToMtb, 
  file.path(results_dir, "Histogram_pvalues_BG_24hr_5_day_media_vs_BG_24hr_5_day_media_MTB_4hr.jpeg")
)

run_pval_histogram(
  dds_NonTrainedResponseToMtb, 
  file.path(results_dir, "Histogram_pvalues_6_day_media_(control)_vs_6_day_media_MTB_4hr.jpeg")
)

# MA Plots
ma_TrainingEffect <- run_ma_plot(
  dds_TrainingEffect, 
  file.path(results_dir, "MAplot_6_day_media_(control)_vs_BG_24hr_5_day_media.jpeg")
)

ma_TrainedResponseToMtb <- run_ma_plot(
  dds_TrainedResponseToMtb, 
  file.path(results_dir, "MAplot_BG_24hr_5_day_media_vs_BG_24hr_5_day_media_MTB_4hr.jpeg")
)

ma_NonTrainedResponseToMtb <- run_ma_plot(
  dds_NonTrainedResponseToMtb, 
  file.path(results_dir, "MAplot_6_day_media_(control)_vs_6_day_media_MTB_4hr.jpeg")
)

# Volcano Plots
run_volcano_plot(
  dds_TrainingEffect, 
  file.path(results_dir, "Volcano_6_day_media_(control)_vs_BG_24hr_5_day_media.jpeg")
)

run_volcano_plot(
  dds_TrainedResponseToMtb, 
  file.path(results_dir, "Volcano_BG_24hr_5_day_media_vs_BG_24hr_5_day_media_MTB_4hr.jpeg")
)

run_volcano_plot(
  dds_NonTrainedResponseToMtb, 
  file.path(results_dir, "Volcano_6_day_media_(control)_vs_6_day_media_MTB_4hr.jpeg")
)


# Análise de Venn (comparando respostas ao Mtb em treinados vs. não treinados)
run_venn_analysis(
  dds_TrainedResponseToMtb, 
  dds_NonTrainedResponseToMtb,
  "BG_24hr_5_day_media_vs_BG_24hr_5_day_media_MTB_4hr", 
  "6_day_media_(control)_vs_6_day_media_MTB_4hr",
  file.path(results_dir, "Venn_BG_24hr_5_day_media_vs_6_day_media_ResponseToMtb")
)

run_venn_analysis(
  dds_TrainingEffect, 
  dds_NonTrainedResponseToMtb,
  "6_day_media_(control)_vs_BG_24hr_5_day_media", 
  "6_day_media_(control)_vs_6_day_media_MTB_4hr",
  file.path(results_dir, "Venn_TrainingEffect_vs_NonTrainedResponseToMtb")
)
...
run_venn_analysis(
  ...
  "6_day_media_(control)_vs_BG_24hr_5_day_media", 
  "BG_24hr_5_day_media_vs_BG_24hr_5_day_media_MTB_4hr",
  file.path(results_dir, "Venn_TrainingEffect_vs_TrainedMtbResponse")
)
...
up_down_enrich_results <- run_deseq_up_down_enrichment(dds = dds_NonTrainedResponseToMtb,
                                                       up_threshold = 1,
                                                       down_threshold = -1,
                                                       padj_cutoff = 0.05,
                                                       ont = "BP",
                                                       ...
                                                       pvalueCutoff = 0.05,
                                                       qvalueCutoff = 0.2,
                                                       output_file_prefix = file.path(results_dir, "DESeq2_UpDown_6_day_media_(control)_vs_6_day_media_MTB_4hr"))



up_down_enrich_results <- run_deseq_up_down_enrichment(dds = dds_TrainedResponseToMtb,
                                                       up_threshold = 1,
                                                       down_threshold = -1,
                                                       padj_cutoff = 0.05,
                                                       ont = "BP",
                                                       ...
                                                       pvalueCutoff = 0.05,
                                                       qvalueCutoff = 0.2,
                                                       output_file_prefix = file.path(results_dir, "DESeq2_UpDown_24hr_5_day_media_vs_BG_24hr_5_day_media_MTB_4hr"))





up_down_enrich_results <- run_deseq_up_down_enrichment(dds = dds_TrainingEffect,
                                                       up_threshold = 1,
                                                       down_threshold = -1,
                                                       padj_cutoff = 0.05,
                                                       ont = "BP",
                                                       ...
                                                       pvalueCutoff = 0.05,
                                                       qvalueCutoff = 0.2,
                                                       output_file_prefix = file.path(results_dir, "DESeq2_UpDown_6_day_media_(control)_vs_BG_24hr_5_day_media"))
