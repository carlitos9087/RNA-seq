...
###########################################
base_dir <- "Deseq2/PRJEB36928 - Leishmania/"
...
phenoData <- read_excel("./Deseq2/PRJEB36928 - Leishmania/SRP377060.xlsx", col_names = TRUE)
lista <- phenoData$id
...
# dds_BALB_c <- run_deseq_analysis(data, phenoData, "Healthy_Linf", "Active_Disease_Linf",
#                                  file.path(results_dir, "DESeq2_Healthy_Linf_vs_Active_Disease_Linf.tabular"))
# 
# 
# dds_C57BL_6 <- run_deseq_analysis(data, phenoData, "Healthy_Linf", "Healthy_Linf_Positive",
#                                   file.path(results_dir, "DESeq2_Control_Non-infected_vs_Linf_Infected.tabular"))
# 


# Executa DESeq2 para as comparações desejadas
dds_Healthy_vs_Active <- run_deseq_analysis(
  data, phenoData, "Healthy_Linf", "Active_Disease_Linf",
  file.path(results_dir, "DESeq2_Healthy_Linf_vs_Active_Disease_Linf.tabular")
)

dds_Healthy_vs_Positive <- run_deseq_analysis(
  data, phenoData, "Healthy_Linf", "Healthy_Linf_Positive",
  file.path(results_dir, "DESeq2_Healthy_Linf_vs_Healthy_Linf_Positive.tabular")
)

# Análises de PCA
pca_Healthy_vs_Active <- run_pca_analysis(
  dds_Healthy_vs_Active, 
  file.path(results_dir, "PCA_Healthy_Linf_vs_Active_Disease_Linf.jpeg")
)

pca_Healthy_vs_Positive <- run_pca_analysis(
  dds_Healthy_vs_Positive, 
  file.path(results_dir, "PCA_Healthy_Linf_vs_Healthy_Linf_Positive.jpeg")
)

# Distâncias entre amostras
run_sample_distances(
  dds_Healthy_vs_Active, 
  file.path(results_dir, "SampleDistances_Healthy_vs_Active_Disease_Linf.jpeg")
)

run_sample_distances(
  dds_Healthy_vs_Positive, 
  file.path(results_dir, "SampleDistances_Healthy_vs_Healthy_Linf_Positive.jpeg")
)

# Gráficos de dispersão
run_dispersion_plot(
  dds_Healthy_vs_Active, 
  file.path(results_dir, "Dispersion_Healthy_vs_Active_Disease_Linf.jpeg")
)

run_dispersion_plot(
  dds_Healthy_vs_Positive, 
  file.path(results_dir, "Dispersion_Healthy_vs_Healthy_Linf_Positive.jpeg")
)

# Histogramas de p-values
run_pval_histogram(
  dds_Healthy_vs_Active, 
  file.path(results_dir, "Histogram_pvalues_Healthy_vs_Active_Disease_Linf.jpeg")
)

run_pval_histogram(
  dds_Healthy_vs_Positive, 
  file.path(results_dir, "Histogram_pvalues_Healthy_vs_Healthy_Linf_Positive.jpeg")
)

# MA Plots
ma_Healthy_vs_Active <- run_ma_plot(
  dds_Healthy_vs_Active, 
  file.path(results_dir, "MAplot_Healthy_vs_Active_Disease_Linf.jpeg")
)

ma_Healthy_vs_Positive <- run_ma_plot(
  dds_Healthy_vs_Positive, 
  file.path(results_dir, "MAplot_Healthy_vs_Healthy_Linf_Positive.jpeg")
)

# Volcano Plots
run_volcano_plot(
  dds_Healthy_vs_Active, 
  file.path(results_dir, "Volcano_Healthy_vs_Active_Disease_Linf.jpeg")
)

run_volcano_plot(
  dds_Healthy_vs_Positive, 
  file.path(results_dir, "Volcano_Healthy_vs_Healthy_Linf_Positive.jpeg")
)
...
run_venn_analysis(
  dds_Healthy_vs_Active, 
  dds_Healthy_vs_Positive,
  "Healthy_vs_Active_Disease", 
  "Healthy_vs_Healthy_Positive",
  file.path(results_dir, "Venn_Healthy_vs_Active_vs_Positive")
)
...
up_down_enrich_dds_Healthy_vs_Active <- run_deseq_up_down_enrichment(
  dds             = dds_Healthy_vs_Active,
  up_threshold    = 1,
  down_threshold  = -1,
  padj_cutoff     = 0.05,
  ontologies      = c("BP","MF"),
  ...
  pvalueCutoff    = 0.05,
  qvalueCutoff    = 0.2,
  output_prefix   = "./Deseq2/PRJEB36928 - Leishmania/results/DESeq2_UpDown_Healthy_vs_Active"
)

up_down_enrich_Healthy_vs_Positive <- run_deseq_up_down_enrichment(
  dds             = dds_Healthy_vs_Positive,
  up_threshold    = 1,
  down_threshold  = -1,
  padj_cutoff     = 0.05,
  ontologies      = c("BP","MF"),
  ...
  pvalueCutoff    = 0.05,
  qvalueCutoff    = 0.2,
  output_prefix   = "./Deseq2/PRJEB36928 - Leishmania/results/DESeq2_UpDown_Healthy_vs_Positive"
)


up_down_enrich_dds_Healthy_vs_Active


up_down_enrich_Healthy_vs_Positive


# Listas de resultados de enriquecimento
resultados <- list(
  dds_Healthy_vs_Active = up_down_enrich_dds_Healthy_vs_Active,
  dds_Healthy_vs_Positive = up_down_enrich_Healthy_vs_Positive
)

# Diretórios de saída correspondentes
diretorios_saida <- list(
  dds_Healthy_vs_Active = "./Deseq2/PRJEB36928 - Leishmania/results/Enrichment_Analysis_Healthy_vs_Active/",
  dds_Healthy_vs_Positive = "./Deseq2/PRJEB36928 - Leishmania/results/Enrichment_Analysis_Healthy_vs_Positive/"
