...
dds_Healthy_vs_Active <- run_deseq_analysis(
  data, phenoData, "Healthy_Linf", "Active_Disease_Linf.tabular",
  file.path(results_dir, "DESeq2_Healthy_Linf_vs_Active_Disease_Linf.tabular")
)

dds_Healthy_vs_Positive <- run_deseq_analysis(
  data, phenoData, "Healthy_Linf", "Healthy_Linf_Positive",
  file.path(results_dir, "DESeq2_Healthy_Linf_vs_Healthy_Linf_Positive")
)
...
up_down_enrich_results <- run_deseq_up_down_enrichment(dds = dds_C57BL_6,
                                                       ...
                                                       pvalueCutoff = 0.05,
                                                       qvalueCutoff = 0.2,
                                                       output_file_prefix = file.path(results_dir, "DESeq2_UpDown__dds_Healthy_Linf_vs_Healthy_Linf_Positive"))
...
up_down_enrich_results <- run_deseq_up_down_enrichment(dds = dds_BALB_c,
                                                       ...
                                                       pvalueCutoff = 0.05,
                                                       qvalueCutoff = 0.2,
                                                       output_file_prefix = file.path(results_dir, "DESeq2_Healthy_Linf_vs_Active_Disease_Linf"))
