...
ma1 = run_ma_plot(dds_nf_ilp, "./Deseq2/SRP377060 - Leishmania/results/MAplot_NonInfected_vs_InfectedLive.jpeg")
...
run_volcano_plot(dds_nf_ilp, "./Deseq2/SRP377060 - Leishmania/results/Volcano_NonInfected_vs_InfectedLive.jpeg")
...
#                                                        pvalueCutoff = 0.05,
#                                                        qvalueCutoff = 0.2,
#                                                        output_file_prefix = "./Deseq2/SRP377060 - Leishmania/results/DESeq2_UpDown")
# 
...
# library(openxlsx)
# 
# out_dir       <- "./Deseq2/results/SRP377060/Enrichment_Analysis/"
...
diretorios_saida <- list(
  dds_nf_ilp = "./Deseq2/SRP377060 - Leishmania/results/teste/Enrichment_Analysis_dds_nf_ilp/",
  dds_nf_ifp = "./Deseq2/SRP377060 - Leishmania/results/teste/Enrichment_Analysis_dds_nf_ifp/"
)
