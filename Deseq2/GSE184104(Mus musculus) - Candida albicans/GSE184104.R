...
up_down_enrich_dds_NonInfected_vs_24h <- run_deseq_up_down_enrichment(
  dds             = dds_NonInfected_vs_24h,
  up_threshold    = 1,
  down_threshold  = -1,
  padj_cutoff     = 0.05,
  ontologies      = c("BP","MF"),
  ...
  pvalueCutoff    = 0.05,
  qvalueCutoff    = 0.2,
  output_prefix = file.path(results_dir, "DESeq2_UpDown_NonInfected_vs_PCA2_24h")
  
)

up_down_enrich_dds_NonInfected_vs_7h <- run_deseq_up_down_enrichment(
  dds             = dds_NonInfected_vs_7h,
  up_threshold    = 1,
  down_threshold  = -1,
  padj_cutoff     = 0.05,
  ontologies      = c("BP","MF"),
  ...
  pvalueCutoff    = 0.05,
  qvalueCutoff    = 0.2,
  output_prefix = file.path(results_dir, "DESeq2_UpDown_NonInfected_vs_PCA2_7h")
...
#########################
resultados <- list(
  dds_NonInfected_vs_24h = up_down_enrich_dds_NonInfected_vs_24h,
  dds_Uninf_vs_Infected = up_down_enrich_dds_NonInfected_vs_7h
)

# Diretórios de saída correspondentes
diretorios_saida <- list(
  dds_NonInfected_vs_24h = file.path(results_dir, "Enrichment_Analysis_UpDown_NonInfected_vs_PCA2_24h"),
  dds_NonInfected_vs_7h =  file.path(results_dir, "Enrichment_Analysis_UpDown_NonInfected_vs_PCA2_7h")
