...
dds_nf_ilp <- run_deseq_analysis(data, phenoData, "Cutaneous", "Mucosal",
                                 "./Deseq2/SRP009251 - Leishmania/results/DESeq2_Cutaneous_vs_Infected.tabular")
# 
...
pca_nf_ilp <- run_pca_analysis(dds_nf_ilp, "./Deseq2/SRP009251 - Leishmania/results/PCA_Cutaneous_vs_Mucosal.jpeg")
...
run_sample_distances(dds_nf_ilp, "./Deseq2/SRP009251 - Leishmania/results/SampleDistances_Cutaneous_vs_Mucosal.jpeg")
...
run_dispersion_plot(dds_nf_ilp, "./Deseq2/SRP009251 - Leishmania/results/Dispersion_Cutaneous_vs_Mucosal.jpeg")
# run_dispersion_plot(dds_nf_ifp, "./Deseq2/SRP377060 - Leishmania/results/Dispersion_NonInfected_vs_InfectedFixed.jpeg")

run_pval_histogram(dds_nf_ilp, "./Deseq2/SRP009251 - Leishmania/results/Histogram_pvalues_Cutaneous_vs_Mucosal.jpeg")
# run_pval_histogram(dds_nf_ifp, "./Deseq2/SRP377060 - Leishmania/results/Histogram_pvalues_NonInfected_vs_InfectedFixed.jpeg")

ma1 = run_ma_plot(dds_nf_ilp, "./Deseq2/SRP009251 - Leishmania/results/MAplot_Cutaneous_vs_Mucosal.jpeg")
...
run_volcano_plot(dds_nf_ilp, "./Deseq2/SRP009251 - Leishmania/results/Volcano_Cutaneous_vs_Mucosal.jpeg")
