...
up_down_enrich_results <- run_deseq_up_down_enrichment(
  ...
  pvalueCutoff    = 0.05,
  qvalueCutoff    = 0.2,
  output_prefix   = "./Deseq2/SRP009251 - Leishmania/results/DESeq2_UpDown_Cutaneous_vs_Mucosal"
)
...
resultados <- list(
  Cutaneous_vs_Mucosal    = up_down_enrich_results
)

# Diretórios de saída correspondentes
diretorios_saida <- list(
  Cutaneous_vs_Mucosal = "./Deseq2/SRP009251 - Leishmania/results/Enrichment_Analysis/"
)
