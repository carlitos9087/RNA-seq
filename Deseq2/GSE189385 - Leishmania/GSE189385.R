...
###########################################
base_dir <- "Deseq2/GSE189385 - Leishmania"
...
phenoData <- read_excel("./Deseq2/GSE189385 - Leishmania/GSE189385.xlsx", col_names = TRUE)
lista <- phenoData$id
...
# Executa DESeq2 para a comparação Mouse_Uninf vs Mouse_infected
dds_Uninf_vs_Infected <- run_deseq_analysis(
  data, 
  phenoData, 
  "Mouse_Uninf",  # Grupo controle
  "Mouse_infected",  # Grupo experimental
  file.path(results_dir, "DESeq2_Mouse_Uninf_vs_Mouse_infected.tabular")  # Nome do arquivo de saída
)

# Análises de PCA
pca_Uninf_vs_Infected <- run_pca_analysis(
  dds_Uninf_vs_Infected, 
  file.path(results_dir, "PCA_Mouse_Uninf_vs_Mouse_infected.jpeg")
)

# Distâncias entre amostras
run_sample_distances(
  dds_Uninf_vs_Infected, 
  file.path(results_dir, "SampleDistances_Mouse_Uninf_vs_Mouse_infected.jpeg")
)

# Gráficos de dispersão
run_dispersion_plot(
  dds_Uninf_vs_Infected, 
  file.path(results_dir, "Dispersion_Mouse_Uninf_vs_Mouse_infected.jpeg")
)

# Histogramas de p-values
run_pval_histogram(
  dds_Uninf_vs_Infected, 
  file.path(results_dir, "Histogram_pvalues_Mouse_Uninf_vs_Mouse_infected.jpeg")
)

# MA Plot
ma_Uninf_vs_Infected <- run_ma_plot(
  dds_Uninf_vs_Infected, 
  file.path(results_dir, "MAplot_Mouse_Uninf_vs_Mouse_infected.jpeg")
)

# Volcano Plot
run_volcano_plot(
  dds_Uninf_vs_Infected, 
  file.path(results_dir, "Volcano_Mouse_Uninf_vs_Mouse_infected.jpeg")
)
...
up_down_enrich_dds_Uninf_vs_Infected<- run_deseq_up_down_enrichment(
  dds             = dds_Uninf_vs_Infected,
  up_threshold    = 1,
  down_threshold  = -1,
  padj_cutoff     = 0.05,
  ontologies      = c("BP","MF"),
  ...
  pvalueCutoff    = 0.05,
  qvalueCutoff    = 0.2,
  output_prefix   = "./Deseq2/PRJNA552352 - Leishmania/results/DESeq2_UpDown_Mouse_Uninf_vs_Mouse_infected"
)



resultados <- list(
  dds_Uninf_vs_Infected = up_down_enrich_dds_Uninf_vs_Infected
)

# Diretórios de saída correspondentes
diretorios_saida <- list(
  dds_Uninf_vs_Infected = "./Deseq2/GSE189385 - Leishmania/results/Enrichment_Analysis_dds_Uninf_vs_Infected/"
