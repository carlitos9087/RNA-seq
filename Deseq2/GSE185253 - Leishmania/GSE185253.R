...
###########################################
base_dir <- "Deseq2/GSE185253 - Leishmania/"
...
phenoData <- read_excel("./Deseq2/GSE185253 - Leishmania/GSE185253.xlsx", col_names = TRUE)
lista <- phenoData$id
...
dds_Uninf_vs_Infected <- run_deseq_analysis(
  data, 
  phenoData, 
  "Mouse_Non_infected",  # Grupo controle
...
up_down_enrich_dds_Uninf_vs_Infected<- run_deseq_up_down_enrichment(
  ...
  pvalueCutoff    = 0.05,
  qvalueCutoff    = 0.2,
  output_prefix = file.path(results_dir, "DESeq2_UpDown_Mouse_Uninf_vs_Mouse_infected")
...
diretorios_saida <- list(
  dds_Uninf_vs_Infected = "./Deseq2/GSE185253 - Leishmania/results/Enrichment_Analysis_dds_Uninf_vs_Infected/"
