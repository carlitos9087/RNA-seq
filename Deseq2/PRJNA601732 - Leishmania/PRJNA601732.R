...
up_down_enrich_results <- run_deseq_up_down_enrichment(dds = dds_C57BL_6,
                                                       ...
                                                       pvalueCutoff = 0.05,
                                                       qvalueCutoff = 0.2,
                                                       output_file_prefix = file.path(results_dir, "DESeq2_UpDown_Infected_Ldonovani_vs_Uninfected"))
...
up_down_enrich_results <- run_deseq_up_down_enrichment(dds = dds_BALB_c,
                                                       ...
                                                       pvalueCutoff = 0.05,
                                                       qvalueCutoff = 0.2,
                                                       output_file_prefix = file.path(results_dir, "DESeq2_UpDown_Infected_Linfantum_vs_Uninfected"))
