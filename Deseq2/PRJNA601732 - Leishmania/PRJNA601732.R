...
###########################################
base_dir <- "Deseq2/PRJNA601732 - Leishmania"
...
phenoData <- read_excel("./Deseq2/PRJNA601732 - Leishmania/PRJNA601732.xlsx", col_names = TRUE)
lista <- phenoData$id
...
intersect(phenoData$SampleName[phenoData$Treatment %in% c("Infected_Ldonovani", "Uninfected")], colnames(data))
intersect(phenoData$SampleName[phenoData$Treatment %in% c("Infected_Linfantum", "Uninfected")], colnames(data))
colnames(data)



# Executa DESeq2 para as comparações desejadas
dds_BALB_c <- run_deseq_analysis(data, phenoData, "Uninfected", "Infected_Ldonovani",
                                 file.path(results_dir, "DESeq2_Uninfected_vs_Infected_Ldonovani.tabular"))


dds_C57BL_6 <- run_deseq_analysis(data, phenoData, "Uninfected", "Infected_Linfantum",
                                  file.path(results_dir, "DESeq2_Uninfected_vs_Infected_Linfantum.tabular"))
...
pca_24h <- run_pca_analysis(dds_BALB_c, file.path(results_dir, "PCA_Uninfected_vs_Infected_Ldonovani.jpeg"))
pca_8h <- run_pca_analysis(dds_C57BL_6, file.path(results_dir, "PCA_Uninfected_vs_Infected_Linfantum.jpeg"))
results_dir


run_sample_distances(dds_BALB_c, file.path(results_dir, "SampleDistances_Uninfected_vs_Infected_Ldonovani.jpeg"))
run_sample_distances(dds_C57BL_6, file.path(results_dir, "SampleDistances_Uninfected_vs_Infected_Linfantum.jpeg"))


run_dispersion_plot(dds_BALB_c, file.path(results_dir, "Dispersion_Uninfected_vs_Infected_Ldonovani.jpeg"))
run_dispersion_plot(dds_C57BL_6, file.path(results_dir, "Dispersion_Uninfected_vs_Infected_Linfantum.jpeg"))


run_pval_histogram(dds_BALB_c, file.path(results_dir, "Histogram_pvalues_Uninfected_vs_Infected_Ldonovani.jpeg"))
run_pval_histogram(dds_C57BL_6, file.path(results_dir, "Histogram_pvalues_Uninfected_vs_Infected_Linfantum.jpeg"))

ma1 = run_ma_plot(dds_BALB_c, file.path(results_dir, "MAplot_Uninfected_vs_Infected_Ldonovani.jpeg"))
ma2 = run_ma_plot(dds_C57BL_6, file.path(results_dir, "MAplot_Uninfected_vs_Infected_Linfantum.jpeg"))

head(ma1$data)

# Executa e salva os Volcano Plots
run_volcano_plot(dds_BALB_c, file.path(results_dir, "Volcano_Uninfected_vs_Infected_Ldonovani.jpeg"))
run_volcano_plot(dds_C57BL_6, file.path(results_dir, "Volcano_Uninfected_vs_Infected_Linfantum.jpeg"))



run_venn_analysis(dds_BALB_c, dds_C57BL_6,
                  "Uninfected_vs_Infected_Ldonovani", "Uninfected_vs_Infected_Linfantum",
...
up_down_enrich_dds_BALB_c <- run_deseq_up_down_enrichment(
  ...
  pvalueCutoff    = 0.05,
  qvalueCutoff    = 0.2,
  output_prefix   = "./Deseq2/PRJNA601732 - Leishmania/results/DESeq2_UpDown_Uninfected_vs_Infected_Ldonovani"
)
...
up_down_enrich_dds_C57BL_6 <- run_deseq_up_down_enrichment(
  ...
  pvalueCutoff    = 0.05,
  qvalueCutoff    = 0.2,
  output_prefix   = "./Deseq2/PRJNA601732 - Leishmania/results/DESeq2_UpDown_Uninfected_vs_Infected_Linfantum"
)
...
diretorios_saida <- list(
  dds_BALB_c = "./Deseq2/PRJNA601732 - Leishmania/results/Enrichment_Analysis_Uninfected_vs_Infected_Ldonovani/",
  dds_C57BL_6 = "./Deseq2/PRJNA601732 - Leishmania/results/Enrichment_Analysis_Uninfected_vs_Infected_Linfantum/"
