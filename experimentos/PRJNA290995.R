...
tabular_dir  <- "/Users/carlitos/Desktop/experimentos/exps fasta/fastas/Leishmania/PRJNA290995/"
...
data = combined_df
write.csv(data, "/Users/carlitos/Desktop/PRJNA290995_dados.csv", row.names = TRUE)

#colnames(data)


# dados da amostra
phenoData  <-  read_excel("/Users/carlitos/Desktop/aaaaaaaaaaaaaaaaaaaaaaaaaaa.xlsx", col_names = TRUE)
lista  <- phenoData$...1
...
dds75 <- dds[rowSums(counts(dds) >= 15) >= 35,]
...
cores_interesse <- c("yellow", "turquoise")
